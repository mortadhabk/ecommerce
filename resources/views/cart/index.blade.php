...
<div class="px-4 px-lg-0">
    ...
    <div class="pb-5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th scope="row" class="border-0">
                          <div class="p-2">
                            <img src="{{ asset('imagets/'. $product->model->image ) }}" alt="" width="70" class="img-fluid rounded shadow-sm">
                        ...
                        @foreach ($product->model->prices as $prix)
                        @if($prix->isActive)
                        <td class="border-0 align-middle"><strong>{{getPrice($prix->price)  }}</strong></td>
                        @endif
                        @endforeach
      ...
      @else
         <div class="col-md-12">
            <div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5 d-flex justify-content-sm-center">

                <!-- Shopping cart table -->
                 <h3 class=""> Votre panier est Vide</h3>
                <!-- End -->
              </div>
