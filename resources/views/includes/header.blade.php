            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 col-md-4 col-6 ">
                    <div class="logo d-block d-lg-none">
                        <a href="index.html"><img src="{{ asset('images/logo/logo.svg') }}" alt=""></a>
                    </div>
                </div>
        ...
        <div class="modal-dialog  modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span class="icon-cross"
                ...
                <div class="modal-box-wrapper">
                    ...
                    <div class="tab-content content-modal-box">
                        ...
                        <div class="tab-pane fade" id="tab_list_07" role="tabpanel">
                            ...
                            <form class="account-form-box" method="POST" action="{{ route('register') }}"
                                ...
                                <div class="single-input">
                                    <input id="email" type="email" placeholder="Email address" @error('email')
                                ...
                                <hr>
                                <div>
                                    <h6>Registre Store</h6>
                                </div>


                                <div class="single-input">
                                    <input type="text" id="title" name="title" placeholder="Boutique Name">
                                    @error('title')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="single-input">
                                    <input type="text" id="descripton" name="description" placeholder="Description ">
                                    @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="single-input">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="customFileLang" name="image" id="image">
                                        <label class="custom-file-label" for="customFileLang">Select Image Store</label>
                                      </div>
                                    @error('image')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
